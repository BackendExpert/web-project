      ...
      <div className="md:flex items-center justify-between bg-gray-700 text-white py-4 md:px-20 px-7">
        <div className="cursor-pointer flex items-center text-white">
          <span className="text-3x1 text-indigo-600 flex">
            ...
            <div className={`rounded items-center py-6 px-4 absolute static bg-gray-700  z-auto z-[-1] left-100 md:w-auto w-auto ml-10 pr-24 md:pl-0 pl-9  md:mr-10 transition-all duration-500 ease-in ${open ? 'top-20':'top-[-650px]'}`}>
              <h1 className="text-3xl md:px-8 px-2 font-bold">About</h1>
              <div className="md:grid grid-cols-4 gap-1 md:px-12 px-6 py-4">                  
                  <div>
