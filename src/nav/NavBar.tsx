              ...
              <div className="md:grid md:grid-cols-5 gap-2 md:px-12 px-0 py-4">                  
                  ...
                  <span className="text-2xl">Administration</span>
                      <ul className="px-4 py-2">
                        ...
                        <li className="pb-[3px] duration-500 hover:bg-white hover:text-gray-700 rounded-sm font-medium"><a href="" className="">Internal Audit Division</a></li>
                  ...
                  <h1 className="text-3xl md:px-0 px-2 py-2 font-bold">Publication</h1> 
